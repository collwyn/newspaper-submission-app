      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-green-800 mb-3">Track Progress</h2>
            <p className="text-green-700 mb-4">
              Monitor the status of your submissions, receive updates, and communicate with editors all in one place.
            </p>
            <button
